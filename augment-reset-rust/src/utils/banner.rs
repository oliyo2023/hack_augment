...
pub fn show_banner() {
    ...
    println!("{}", "╔══════════════════════════════════════════════════════════════════════════════╗".bright_cyan());
    println!("{}", "║                                                                              ║".bright_cyan());
    println!("{}", "║                          🚀 Augment Free Trail 🚀                          ║".bright_cyan());
    println!("{}", "║                                                                              ║".bright_cyan());
    println!("{}", "║                        Augment IDE 清理工具 (Rust版本)                       ║".bright_cyan());
    println!("{}", "║                                                                              ║".bright_cyan());
    println!("{}", "║                              版本: v2.2.0                                   ║".bright_cyan());
    println!("{}", "║                                                                              ║".bright_cyan());
    println!("{}", "║                          公众号: 趣惠赚                                       ║".bright_cyan());
    println!("{}", "║                        网站: https://www.oliyo.com                          ║".bright_cyan());
    println!("{}", "║                                                                              ║".bright_cyan());
    println!("{}", "║                    🎯 高性能 • 内存安全 • 跨平台支持                          ║".bright_cyan());
    println!("{}", "║                                                                              ║".bright_cyan());
    println!("{}", "╚══════════════════════════════════════════════════════════════════════════════╝".bright_cyan());
    println!();
}
